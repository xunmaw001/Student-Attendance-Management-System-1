<template>
    <div style="backgroundImage: url('/xueshengkaoqinguanlia/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                ...
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="联系方式" class="input" v-if="tableName=='fudaoyuan'">
                            <el-input v-model="ruleForm.fudaoyuanPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='fudaoyuan'">
                            <el-input v-model="ruleForm.fudaoyuanEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
                        ...
                        <el-form-item label="院系考勤管理姓名" class="input" v-if="tableName=='kaoqinguanli'">
                            <el-input v-model="ruleForm.kaoqinguanliName" autocomplete="off" placeholder="院系考勤管理姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='kaoqinguanli'">
                            <el-input v-model="ruleForm.kaoqinguanliPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='kaoqinguanli'">
                            <el-input v-model="ruleForm.kaoqinguanliEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.kaoqinguanliName)&& 'kaoqinguanli'==this.tableName){
                                this.$message.error('院系考勤管理姓名不能为空');
                                return
                            }
                             if('kaoqinguanli' == this.tableName && this.ruleForm.kaoqinguanliPhone&&(!this.$validate.isMobile(this.ruleForm.kaoqinguanliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('kaoqinguanli' == this.tableName && this.ruleForm.kaoqinguanliEmail&&(!this.$validate.isEmail(this.ruleForm.kaoqinguanliEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
